  ...
  // WashWorld
    {
        ...
        timeline: "Mar `22",
        description: `"Wash World" - Car service center management system, it was a live project made for an automatic car washing center named Wash World Knr. The Application is a basic system which contains data entry and storing, billing system etc...where the company can maintain coustomer details and employment details, the project is completely based on VB.NET. Deployed as an Application for windows PC.`,
