...
import WashWorldBG from "../public/images/project-bg/WashWorld.png";
import SocietyAndMoreBG from "../public/images/project-bg/SocietyAndMore.png";
import {
  platforms,
  db,
  iot,
...
const projects = [
  // Vaidyuti
  {
    ...
    otherLinks: [
      ...
      },
      {
        label: "Docs",
        icon: <SiGitbook />,
        url: "https://abhimanyurajeesh.gitbook.io/vaidyuti-system-design-documentation/",
      },
    ],
    tags: [
  ...
  // IoT based Push-Pull converter
  {
    ...
    image: IoTBasedPSBG,
    link: "https://github.com/abhimanyurajeesh/iot-based-power-supply",
    timeline: "Dec `21",
    description:
    ...
    repository: "https://github.com/abhimanyurajeesh/iot-based-power-supply",
    otherLinks: [
      {
  ...
  // Swiftly
  {
    ...
    image: SwiftlyBG,
    link: "https://github.com/abhimanyurajeesh/swiftly",
    timeline: "Apr `22",
    description:
    ...
    repository: "https://github.com/abhimanyurajeesh/swiftly",
    otherLinks: [
      {
        label: "Staging",
        icon: <IoIosRocket />,
        url: "https://abhimanyurajeesh-swiftly.netlify.app/",
      },
    ],
    tags: [
      frameworks.React,
  ...
  // Arike
  {
    title: "Arike",
    image: ArikeBG,
    link: "https://github.com/abhimanyurajeesh/arike",
    timeline: "Mar `22",
    ...
    repository: "https://github.com/abhimanyurajeesh/arike",
    otherLinks: [
      {
        label: "Staging",
        icon: <IoIosRocket />,
        url: "http://abhimanyurajeesh-arike.herokuapp.com/",
      },
    ],
    tags: [
      frameworks.Tailwind,
  ...
  // Javascript Training
  {
    ...
    image: MartialArtsBG,
    link: "https://abhimanyurajeesh.github.io/",
    timeline: "Jan `22",
    description:
    ...
    repository: "https://github.com/abhimanyurajeesh/abhimanyurajeesh.github.io",
    otherLinks: [
      {
        label: "",
        icon: <IoIosRocket />,
        url: "https://abhimanyurajeesh.github.io/",
      },
      {
        label: "PLAY MARTIAL ARTS",
        icon: <IoLogoGameControllerB />,
        url: "https://abhimanyurajeesh.github.io/martial-arts/",
      },
    ],
  ...
  // VITCC Electrical Issues
  {
    ...
    repository: "https://github.com/abhimanyurajeesh/vitcc_electrical_issues",
    otherLinks: [
      {
        label: "Production",
        icon: <IoIosRocket />,
  ...
  // Standalone 3D Position Sensor
  {
    ...
    link: "https://github.com/abhimanyurajeesh/standalone-3d-position-sensor",
    timeline: "Nov `20",
    description:
    ...
    repository:
      "https://github.com/abhimanyurajeesh/standalone-3d-position-sensor",
    otherLinks: [
      {
        label: "Watch Demo",
        icon: <BsYoutube />,
  ...
  // AUXPIS BPS
  {
    ...
    image: BuckBoostBG,
    link: "https://github.com/abhimanyurajeesh/auxpis-bps",
    timeline: "May `20",
    description:
    ...
    repository: "https://github.com/abhimanyurajeesh/auxpis-bps",
    otherLinks: [
      {
  ...
  */ 
   // Society&More 
    {
        title: "Society & More",
        image: SocietyAndMoreBG,
        link: "https://github.com/abhimanyurajeesh/Society-More",
        timeline: "Oct `22",
        description: `"Society&More" is a pioneering web application designed to foster the development of sustainable societies. Built on the robust ASP.NET framework and powered by C#, it exemplifies cutting-edge technology harnessed for the greater good. This innovative platform aims to address contemporary societal challenges by providing a comprehensive suite of features and tools tailored to promote sustainability at various levels. `,
        repository: "https://github.com/abhimanyurajeesh/Society-More",
        otherLinks: [
            {
                label: "Docs",
                icon: <SiGitbook />,
  ...
  // WashWorld
    {
        title: "Wash World",
        image: WashWorldBG,
        link: "https://github.com/abhimanyurajeesh/WashWorldknr",
        timeline: "Mar `22",
        description: `"Wash World," a car service center management system, was a live project made for an automatic car washing center named Wash World Knr. The application is a basic system that contains data entry and storage, a billing system, etc., where the company can maintain customer and employee details. The project is completely based on VB.NET. Deployed as an application for Windows PCs.`,
        repository: "https://github.com/abhimanyurajeesh/WashWorldknr",
        otherLinks: [
            {
                label: "Carwash",
                icon: <MdLocalCarWash />,
      ...
      // Smart Junction
  {
    ...
    otherLinks: [
      ...
      },
      {
        label: "Docs",
        icon: <SiGitbook />,
        url: "https://github.com/abhimanyurajeesh/Smart-Junction/blob/master/Smart%20Junction%20Documentation.pdf",
      },
    ],
    tags: [
      langs.CSharp,
